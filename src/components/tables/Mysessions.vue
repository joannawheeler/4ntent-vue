<template>
  <div>
          ...
          <b-table hover :items="myplans" :fields="fields">
            <template slot="partic" slot-scope="row">
              <div class="dropdown d-inline-flex" v-dropdown>
                <button class="btn btn-sm dropdown-toggle theme-toggle " type="button" id="dropdownMenuButton"
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <div class="dropdown-menu-content">
                    <a v-for="people in row.item.participant" class="dropdown-item" @click.stop='null'>
                      <div>{{people.name}}</div>
                    </a>
                  </div>
                </div>
    ...
    <!-- <vuestic-widget>
      <div class="row">
        <div class="col-md-9">
          <h5>You have a meeting scheduled for: {{datepicker.multiple}}</h5>
          <br>
        </div>
          ...
          <fieldset>
            <div class="form-group">
              <div class="input-group">
                ...
                />
                Clicking dates here doesn't do anything
              </div>
            </div>
          </fieldset>
          </div>
