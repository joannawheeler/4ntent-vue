            ...
            <div slot="page1" class="form-wizard-tab-content">
              ...
              >
                <div class="input-group">
                  <input name="hsName" data-vv-as="Name" v-model="hsName" v-validate="'required'" required title="" />
        ...
        <vuestic-widget class="no-h-padding" :headerText="$t('forms.wizard.rich')">
          <vuestic-wizard :steps="hrSteps" wizard-type="rich">
            <div slot="page1" class="form-wizard-tab-content">
              ...
              >
                <div class="input-group">
                  <input name="hrName" data-vv-as="Name" v-model="hrName" v-validate="'required'" required title="" />
                  <i class="fa fa-exclamation-triangle error-icon icon-right input-icon"></i>
                  <i class="fa fa-check valid-icon icon-right input-icon"></i>
                  <label class="control-label">{{ 'forms.wizard.name' | translate }}</label
                  ><i class="bar"></i>
        ...
        <vuestic-widget :headerText="$t('forms.wizard.verticalRich')">
          <vuestic-wizard :steps="vrSteps" wizard-layout="vertical" wizard-type="rich">
            <div slot="page1" class="form-wizard-tab-content">
              ...
              >
                <div class="input-group">
                  <input name="vrName" data-vv-as="Name" v-model="vrName" v-validate="'required'" required title="" />
                  <i class="fa fa-exclamation-triangle error-icon icon-right input-icon"></i>
                  <i class="fa fa-check valid-icon icon-right input-icon"></i>
                  <label class="control-label">{{ 'forms.wizard.name' | translate }}</label
                  ><i class="bar"></i>
        ...
        <vuestic-widget class="simple-vertical-wizard-widget" :headerText="$t('forms.wizard.verticalSimple')">
          <vuestic-wizard :steps="vsSteps" wizard-layout="vertical" wizard-type="simple">
            <div slot="page1" class="form-wizard-tab-content">
              ...
              >
                <div class="input-group">
                  <input name="vsName" data-vv-as="Name" v-model="vsName" v-validate="'required'" required title="" />
                  <i class="fa fa-exclamation-triangle error-icon icon-right input-icon"></i>
                  <i class="fa fa-check valid-icon icon-right input-icon"></i>
                  <label class="control-label">{{ 'forms.wizard.name' | translate }}</label
                  ><i class="bar"></i>
